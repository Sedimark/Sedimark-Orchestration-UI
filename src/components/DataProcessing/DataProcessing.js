...
function DataProcessing({logout}) {
    ...
    const selectedPipelineNameStreaming = useSelector((state) => state.selectedPipelineNameStreaming);
            ...
            <TabContext value={selectedTab} className="tabs-container">
                            <Box sx={{ borderBottom: 1, borderColor: 'divider', marginLeft:"250px" }}>
                                <TabList onChange={handleChangeTab} aria-label="lab API tabs example">
                                    ...
                                    <Tab label={<div className="tab-name"> <p>Streaming </p>  {selectedPipelineNameStreaming.length !== 0 && <p class="blue-dot"></p>}</div>} value="4" />
                                </TabList>
                            </Box>
                ...
                <TabPanel value="4" sx={{padding:"0px"}}>
                    <PipelineView pipelineType="streaming"/>
                </TabPanel>
            </TabContext>
            <LeftMenu  />
        </div>
